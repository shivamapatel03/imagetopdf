...
export const ReadyState: React.FC<ReadyStateProps> = ({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-3xl p-8 sm:p-12 text-center max-w-xl mx-auto space-y-6">
      ...
      <div className="pt-4 border-t border-gray-100 w-full max-w-full overflow-hidden">
        <AdBanner slot={process.env.NEXT_PUBLIC_ADSENSE_SLOT_STUDIO || '5606768599'} format="auto" />
      </div>
    </div>
  );
};
